 ...
 */
@Component
@ConfigurationProperties(prefix = "kettle.etl.jdbc.internation")
public class InternationJdbc implements JdbcConfig {
    private String url;
    ...
    @Override
    public String name() {
        return KettleModuleEnum.INTERNATIONAL.getText();
    }
}
